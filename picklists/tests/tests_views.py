...
class PicklistsViews(DataTestClient):
    ...
    def setUp(self):
        ...
        self.create_picklist_item(
            "#2", self.team, PicklistType.REPORT_SUMMARY, PickListStatus.ACTIVE
        )
        self.create_picklist_item(
            "#3", self.team, PicklistType.REPORT_SUMMARY, PickListStatus.DEACTIVATED
        )
        self.create_picklist_item(
            "#4", other_team, PicklistType.ECJU, PickListStatus.ACTIVE
        )

...
urlpatterns = [
    ...
    path("<uuid:pk>/case-officer/", views.CaseOfficer.as_view(), name="case_officers"),
    path("<uuid:pk>/case-officer/<uuid:gov_user_pk>/", views.CaseOfficer.as_view(), name="case_officer"),

...
urlpatterns = [
    ...
    path(
        "<uuid:pk>/team-advice/",
        views.CaseTeamAdvice.as_view(),
        name="case_team_advice",
    ),
    # ex: /cases/<uuid:pk>/team-advice/<uuid:team_pk>/
    path(
        "<uuid:pk>/view-team-advice/<uuid:team_pk>/",
        views.ViewTeamAdvice.as_view(),
        name="view_team_advice",
    ),
    # ex: /cases/<uuid:pk>/final-advice/
    path(
        "<uuid:pk>/final-advice/",
        views.CaseFinalAdvice.as_view(),
        name="case_final_advice",
    ),
    # ex: /cases/<uuid:pk>/view-final-advice/
    path(
        "<uuid:pk>/view-final-advice/",
        views.ViewFinalAdvice.as_view(),
        name="view_final_advice",
    ),
    # ex: /cases/<uuid:pk>/goods-countries-decisions/
    path(

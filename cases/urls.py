...
urlpatterns = [
    ...
    path("<uuid:pk>/case-officers/", views.CaseOfficers.as_view(), name="case_officers"),
    path("<uuid:pk>/case-officers/<uuid:gov_user_pk>/", views.CaseOfficer.as_view(), name="case_officer"),

...
class CaseManager(models.Manager):
    ...
    def search(
        ...
        """
        case_qs = self.submitted().prefetch_related("queues", "case_assignments", "case_assignments__user", "case_ecju_query", "case_assignments__queue", "status", "organisation__flags", "case_type")

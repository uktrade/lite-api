...
class FinaliseCaseTests(DataTestClient):
    def setUp(self):
        ...
        self.create_advice(self.gov_user, self.standard_case, "good", AdviceType.APPROVE, Advice)
    ...
    def test_grant_clearance_success(self, send_exporter_notifications_func):
        ...
        self.create_advice(self.gov_user, clearance_case, "good", AdviceType.APPROVE, Advice)

...
class GoodSerializer(serializers.ModelSerializer):
    description = serializers.CharField(max_length=280,
                                        error_messages={'blank': get_const_string('FORM_DEFAULT_ERROR_TEXT_BLANK')})
    is_good_controlled = serializers.ChoiceField(choices=GoodControlled.choices,
                                                 error_messages={'required': get_const_string('FORM_DEFAULT_ERROR_RADIO_REQUIRED')})
    control_code = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    is_good_end_product = serializers.BooleanField(error_messages={'required': get_const_string('FORM_DEFAULT_ERROR_RADIO_REQUIRED')})

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('missing_document_reason', models.CharField(choices=[('NO_DOCUMENT', 'No document available for the product'), ('OFFICIAL_SENSITIVE', 'Document is above official-sensitive')], max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefix', models.TextField(blank=True, max_length=30, null=True)),
                ('suffix', models.TextField(blank=True, max_length=30, null=True)),
                ('issuing_authority', models.TextField(blank=True, max_length=100, null=True)),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('missing_document_reason', models.CharField(choices=[('NO_DOCUMENT', 'No document available for the product'), ('OFFICIAL_SENSITIVE', 'Document is above official-sensitive'), ('COMMERCIALLY_SENSITIVE', 'Document is commercially sensitive')], max_length=30, null=True)),

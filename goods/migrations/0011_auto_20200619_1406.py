# Generated by Django 2.2.13 on 2020-06-19 14:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name="good", name="component_details", field=models.CharField(max_length=255, null=True),
        ),
        migrations.AddField(
            model_name="good", name="information_security_details", field=models.CharField(max_length=255, null=True),
        ),
        migrations.AddField(
            model_name="good",
            name="is_component",
        ...
        migrations.AddField(
            model_name="good", name="modified_military_use_details", field=models.CharField(max_length=255, null=True),
        ),
        migrations.AddField(

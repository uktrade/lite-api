...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('yes_designed', 'Yes, designed specifically for military use'), ('yes_modified', 'Yes, modified for military use'), ('no', 'No')], max_length=15, null=True),
        ),
        migrations.AddField(
            model_name='good',
            name='item_category',

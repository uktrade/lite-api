...
class GoodsTypeList(APIView):
    ...
    def get(self, request):
        ...
        return response_serializer(GoodsTypeSerializer, obj=goods, many=True, response_name='goods')
    ...
    def post(self, request):
        ...
        return response_serializer(GoodsTypeSerializer, data=data, response_name='good')
...
class GoodsTypeDetail(APIView):
    ...
    def get(self, request, pk):
        ...
        if isinstance(request.user, GovUser):
            serializer = FullGoodsTypeSerializer
        else:
            serializer = GoodsTypeSerializer

        return response_serializer(serializer, pk=pk, object_class=GoodsType, response_name='good')

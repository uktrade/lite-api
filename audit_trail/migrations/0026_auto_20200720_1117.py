# Generated by Django 2.2.13 on 2020-07-20 11:17

import audit_trail.enums
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (audit_trail.enums.AuditType("good_reviewed_with_comment"), "good_reviewed_with_comment"),
                    ...
                    (audit_trail.enums.AuditType("assign_user_to_case"), "assign_user_to_case"),
                    ...
                    (audit_trail.enums.AuditType("reinstated_application"), "reinstated_application"),
                    ...
                    (audit_trail.enums.AuditType("created_document_template"), "created_document_template"),
                    ...
                    (
                        audit_trail.enums.AuditType("removed_letter_template_paragraphs"),
                        "removed_letter_template_paragraphs",
                    ),
                    (
                        audit_trail.enums.AuditType("added_letter_template_paragraphs"),
                    ...
                    (
                        audit_trail.enums.AuditType("updated_letter_template_include_digital_signature"),
                    ...
                    (
                        audit_trail.enums.AuditType("removed_flag_on_organisation_with_note"),
                        "removed_flag_on_organisation_with_note",
                    ),
                    (audit_trail.enums.AuditType("added_flag_on_organisation"), "added_flag_on_organisation"),
                    (
                        audit_trail.enums.AuditType("added_flag_on_organisation_with_note"),
                        "added_flag_on_organisation_with_note",
                    ),
                    ...
                    (audit_trail.enums.AuditType("added_next_review_date"), "added_next_review_date"),
                    (audit_trail.enums.AuditType("edited_next_review_date"), "edited_next_review_date"),
                    (audit_trail.enums.AuditType("removed_next_review_date"), "removed_next_review_date"),
                    (audit_trail.enums.AuditType("compliance_visit_case_created"), "compliance_visit_case_created"),
                    (audit_trail.enums.AuditType("compliance_visit_case_updated"), "compliance_visit_case_updated"),
                    (
                        audit_trail.enums.AuditType("compliance_people_present_created"),
                        "compliance_people_present_created",
                    ),
                    (
                        audit_trail.enums.AuditType("compliance_people_present_updated"),
                        "compliance_people_present_updated",
                    ),
                    (
                        audit_trail.enums.AuditType("compliance_people_present_deleted"),
                        "compliance_people_present_deleted",
                    ),
                    (
                        audit_trail.enums.AuditType("updated_good_on_destination_matrix"),
                        "updated_good_on_destination_matrix",
                    ),
                    (audit_trail.enums.AuditType("licence_updated_good_usage"), "licence_updated_good_usage"),
                    (audit_trail.enums.AuditType("licence_updated_status"), "licence_updated_status"),
                ],
                db_index=True,
                max_length=255,
            ),

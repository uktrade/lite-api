...
from api.exporter_answers.enums import STATUS_CHOICES, STATUS_ACTIVE, STATUS_SUPERSEDED
...
class ExporterAnswerSet(TimestampableModel):
    ...
    status = models.CharField(choices=STATUS_CHOICES, default=STATUS_ACTIVE, max_length=50)

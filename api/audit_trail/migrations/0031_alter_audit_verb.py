# Generated by Django 4.2.20 on 2025-04-29 13:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("audit_trail", "0030_alter_audit_verb"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (api.audit_trail.enums.AuditType["REMOVE_USER_FROM_CASE"], "remove_user_from_case"),
                    ...
                    (
                        api.audit_trail.enums.AuditType["CREATED_CASE_NOTE_WITH_MENTIONS"],
                        "created_case_note_with_mentions",
                    ),
                    (api.audit_trail.enums.AuditType["ECJU_QUERY"], "ecju_query"),
                    (api.audit_trail.enums.AuditType["ECJU_QUERY_RESPONSE"], "ecju_query_response"),
                    (api.audit_trail.enums.AuditType["ECJU_QUERY_MANUALLY_CLOSED"], "ecju_query_manually_closed"),
                    (api.audit_trail.enums.AuditType["UPDATED_STATUS"], "updated_status"),
                    (api.audit_trail.enums.AuditType["UPDATED_SUB_STATUS"], "updated_sub_status"),
                    ...
                    (
                        api.audit_trail.enums.AuditType["DOCUMENT_ON_ORGANISATION_DELETE"],
                        "document_on_organisation_delete",
                    ),
                    (
                        api.audit_trail.enums.AuditType["DOCUMENT_ON_ORGANISATION_UPDATE"],
                        "document_on_organisation_update",
                    ),
                    ...
                    (api.audit_trail.enums.AuditType["UPDATED_SERIAL_NUMBERS"], "updated_serial_numbers"),
                    (api.audit_trail.enums.AuditType["PRODUCT_REVIEWED"], "product_reviewed"),
                    (api.audit_trail.enums.AuditType["LICENCE_UPDATED_PRODUCT_USAGE"], "licence_updated_product_usage"),
                    (api.audit_trail.enums.AuditType["CREATED_FINAL_RECOMMENDATION"], "created_final_recommendation"),
                    (api.audit_trail.enums.AuditType["GENERATE_DECISION_LETTER"], "generate_decision_letter"),
                    (api.audit_trail.enums.AuditType["DECISION_LETTER_SENT"], "decision_letter_sent"),
                    (api.audit_trail.enums.AuditType["LU_ADVICE"], "lu_advice"),
                    (api.audit_trail.enums.AuditType["LU_EDIT_ADVICE"], "lu_edit_advice"),
                    (api.audit_trail.enums.AuditType["LU_COUNTERSIGN"], "lu_countersign"),
                    (api.audit_trail.enums.AuditType["LU_EDIT_MEETING_NOTE"], "lu_edit_meeting_note"),
                    (api.audit_trail.enums.AuditType["LU_CREATE_MEETING_NOTE"], "lu_create_meeting_note"),
                    (api.audit_trail.enums.AuditType["CREATE_REFUSAL_CRITERIA"], "create_refusal_criteria"),
                    (api.audit_trail.enums.AuditType["EXPORTER_APPEALED_REFUSAL"], "exporter_appealed_refusal"),
                    (api.audit_trail.enums.AuditType["EXPORTER_CREATED_AMENDMENT"], "exporter_created_amendment"),
                    (api.audit_trail.enums.AuditType["EXPORTER_SUBMITTED_AMENDMENT"], "exporter_submitted_amendment"),
                    (api.audit_trail.enums.AuditType["AMENDMENT_CREATED"], "amendment_created"),
                    (api.audit_trail.enums.AuditType["DEVELOPER_INTERVENTION"], "developer_intervention"),
                    (
                        api.audit_trail.enums.AuditType["ADD_EXPORTER_USER_TO_ORGANISATION"],
                        "add_exporter_user_to_organisation",
                    ),
                    (
                        api.audit_trail.enums.AuditType["CREATE_BULK_APPROVAL_RECOMMENDATION"],
                        "create_bulk_approval_recommendation",
                    ),
                    (
                        api.audit_trail.enums.AuditType["CREATE_OGD_F680_RECOMMENDATION"],
                        "create_ogd_f680_recommendation",
                    ),
                    (api.audit_trail.enums.AuditType["CLEAR_OGD_F680_RECOMMENDATION"], "clear_ogd_f680_recommendation"),
                    (api.audit_trail.enums.AuditType["CREATE_F680_OUTCOME"], "create_f680_outcome"),
                    (api.audit_trail.enums.AuditType["CLEAR_F680_OUTCOME"], "clear_f680_outcome"),
                ],
                db_index=True,
                max_length=255,
            ),

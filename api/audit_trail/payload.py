...
audit_type_format = {
    ...
    AuditType.ADD_FLAGS: formatters.add_flags,
    AuditType.REMOVE_FLAGS: formatters.remove_flags,
    AuditType.GOOD_REVIEWED: strings.Audit.GOOD_REVIEWED,
    AuditType.GOOD_ADD_FLAGS: formatters.good_add_flags,
    AuditType.GOOD_REMOVE_FLAGS: formatters.good_remove_flags,
    AuditType.GOOD_ADD_REMOVE_FLAGS: formatters.good_add_remove_flags,
    AuditType.DESTINATION_ADD_FLAGS: formatters.destination_add_flags,
    AuditType.DESTINATION_REMOVE_FLAGS: formatters.destination_remove_flags,
    AuditType.ADD_GOOD_TO_APPLICATION: "added the product {good_name}.",
    AuditType.REMOVE_GOOD_FROM_APPLICATION: "removed the product {good_name}",
    ...
    AuditType.ASSIGN_USER_TO_CASE: "allocated {user} as case adviser on {queue}",
    AuditType.REMOVE_USER_FROM_CASE: "removed {removed_user_name} as case adviser on {removed_user_queue_name}",
    AuditType.REMOVE_CASE: strings.Audit.REMOVE_CASE,
    AuditType.REMOVE_CASE_FROM_ALL_QUEUES: "removed the case from all queues",
    AuditType.REMOVE_CASE_FROM_ALL_USER_ASSIGNMENTS: "removed the case from all user assignments",
    ...
    AuditType.REVIEW_COMBINE_ADVICE: "reviewed and combined recommendations",
    ...
    AuditType.ADD_CASE_OFFICER_TO_CASE: "allocated {case_officer} as Licensing Unit case officer",
    AuditType.REMOVE_CASE_OFFICER_FROM_CASE: "removed {case_officer} as Licensing Unit case officer",
    AuditType.GRANTED_APPLICATION: formatters.granted_application,
    AuditType.REINSTATED_APPLICATION: formatters.reinstated_application,
    ...
    AuditType.REMOVED_FLAG_ON_ORGANISATION: formatters.remove_flags,
    ...
    AuditType.LICENCE_UPDATED_STATUS: formatters.licence_status_updated,
    ...
    AuditType.LU_EDIT_NOTE: formatters.update_lu_note,
    AuditType.LU_CREATE_NOTE: formatters.create_lu_note,
}

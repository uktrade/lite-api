...
urlpatterns = [
    ...
    path("<uuid:pk>/update/", organisations.OrganisationsDraftDetail.as_view(), name="organisation_draft_update"),
    path(
    ...
    path(
        "<uuid:pk>/documents/",
        documents.DocumentOnOrganisationView.as_view({"get": "list", "post": "create"}),
        name="documents",
    ),
    path(
    ...
    path("registration_number/", organisations.ValidateRegistrationNumber.as_view()),
]

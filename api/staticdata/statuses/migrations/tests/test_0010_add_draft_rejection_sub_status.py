...
class TestAddCaseSubStatusDraftRejectionLetter(MigratorTestCase):
    ...
    migrate_from = ("statuses", "0009_update_request_received_name")
    migrate_to = ("statuses", "0010_add_draft_rejection_sub_status")

    def test_migration_0010_add_draft_rejection_sub_status(self):

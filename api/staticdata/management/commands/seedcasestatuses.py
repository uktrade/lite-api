...
class Command(SeedCommand):
    ...
    force_help_message = "Running this command will likely overwrite changes made to CaseStatus records.  ONLY DO THIS IF YOU REALLY MEAN TO.  Use the --force flag to acknowledge the risks and run."  # noqa
    ...
    def operation(self, *args, **options):
        ...
        del status_csv["is_terminal"]
        del status_csv["is_read_only}"]

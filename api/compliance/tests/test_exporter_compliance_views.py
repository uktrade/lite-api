...
class ComplianceExporterViewTests(DataTestClient):
    def compare_compliance_case_in_list(self, data, case, site):
        ...
        self.assertEqual(data["address"]["address_line_3"], site.address.address_line_3)
    ...
    def test_exporter_site_details(self):
        ...
        self.assertEqual(response_data["address"]["address_line_3"], comp_case_1.site.address.address_line_3)

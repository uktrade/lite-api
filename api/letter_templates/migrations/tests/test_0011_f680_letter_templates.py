...
class TestF680ExistingLetterTemplatesMigration(MigratorTestCase):
    ...
    def prepare(self):
        ...
        f680_approval_layout = LetterLayout.objects.create(name="F680 Approval", filename="f680_approval")
        f680_refusal_layout = LetterLayout.objects.create(name="F680 Refusal", filename="f680_refusal")

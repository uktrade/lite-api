...
def _get_goods_context(application, final_advice, licence=None):
    ...
    approve_list = goods_context.pop(AdviceType.APPROVE)
    ordered_lst = sorted(approve_list, key=lambda d: d["created_at"]) 
    goods_context[AdviceType.APPROVE] = ordered_lst

...
class DraftTests(DataTestClient):
    ...
    def test_view_draft_MOD_clearances_list_as_exporter_success(self, type):
        ...
        self.assertEqual(
            response_data[0]["case_type"]["sub_type"]["key"],
    ...
    def test_view_draft_gifting_clearance_as_exporter_success(self):
        ...
        self.assertEqual(
            retrieved_application["case_type"]["reference"]["key"],
            application.case_type.reference,
        )
        self.assertIsNotNone(retrieved_application["created_at"])
        self.assertIsNotNone(retrieved_application["updated_at"])
        self.assertIsNone(retrieved_application["submitted_at"])
        ...
        self.assertEqual(
            retrieved_application["end_user"]["id"],
            str(application.end_user.party.id),
        )
        self.assertEqual(
            retrieved_application["third_parties"][0]["id"],
            str(application.third_parties.get().party.id),
        )
    ...
    def test_view_draft_open_application_as_exporter_success(self):
        ...
        self.assertEqual(
            retrieved_application["case_type"]["reference"]["key"],
            open_application.case_type.reference,
        )
        ...
        self.assertIsNotNone(
            CountryOnApplication.objects.filter(application__id=open_application.id).count(),
            1,
        )
        self.assertEqual(

...
def get_f680_application(pk, organisation_id=None):
    kwargs = {}
    if organisation_id:
    ...
    if application_type != CaseTypeSubTypeEnum.F680:
        raise NotImplementedError(f"get_f680_application does not support this application type: {application_type}")

    qs = F680Application.objects.select_related(
        "baseapplication_ptr",

...
class F680ClearanceApplication(BaseApplication):
    ...
    foreign_technology = models.BooleanField(null=True)
    foreign_technology_description = models.CharField(max_length=2200, null=True)

    locally_manufactured = models.BooleanField(null=True)
    ...
    electronic_warfare_requirement = models.BooleanField(null=True)

    uk_service_equipment = models.BooleanField(null=True)

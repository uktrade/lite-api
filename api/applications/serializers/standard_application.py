...
from api.staticdata.trade_control.enums import (
...
class StandardApplicationListSerializer(serializers.Serializer):
...
class StandardApplicationCopySerializer(serializers.ModelSerializer):
    """
    Serializer for copying applications

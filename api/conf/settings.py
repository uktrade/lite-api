...
INSTALLED_APPS = [
    ...
    "rest_framework",
    "api.static",
    "api.static.case_types",
    "api.static.control_list_entries",
    "api.static.countries",
    "api.static.decisions",
    "api.static.denial_reasons",
    "api.static.f680_clearance_types",
    "api.static.letter_layouts",
    "api.static.private_venture_gradings",
    "api.static.statuses",
    "api.static.trade_control",
    "api.static.units",
    "api.static.upload_document_for_tests",
    "api.teams",
    "api.users",

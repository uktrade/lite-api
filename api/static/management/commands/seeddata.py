...
from api.static.management.commands.seedapplications import Command as AppCommand
from api.static.management.commands.seedorganisation import Command as OrgCommand

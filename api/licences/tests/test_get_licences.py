...
class LicenceDetailsTests(DataTestClient):
    ...
    def test_update_licence_details_audit_trail(self):
        ...
        assert (
            audit_data["text"]
            == f"set the licence status of {self.standard_application_licence.reference_code} from {self.standard_application_licence.status} to suspended."
        )

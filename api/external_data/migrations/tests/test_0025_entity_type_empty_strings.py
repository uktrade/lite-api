...
class TestDenialEntityTypeSet(MigratorTestCase):
    migrate_from = ("external_data", "0024_denials_data_migration")
    migrate_to = ("external_data", "0025_entity_type_empty_strings")
    ...
    def test_0025_set_entity_type_empty_strings(self):

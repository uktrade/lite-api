...
class PopulateSanctionsTests(DataTestClient):
    ...
    def test_populate_sanctions(
        ...
        self.assertEqual(results_one.hits[0]["flag_uuid"], "UN SC")
        ...
        self.assertEqual(results_two.hits[0]["flag_uuid"], "UN SC")
        ...
        self.assertEqual(results_three.hits[0]["flag_uuid"], "OFSI")
        ...
        self.assertEqual(results_three.hits[1]["flag_uuid"], "UK sanction")

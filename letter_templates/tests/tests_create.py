...
class LetterTemplateCreateTests(DataTestClient):
    ...
    def test_create_letter_templates_success(self):
        ...
        data = {
            ...
            "case_types": [CaseTypeTypeEnum.GOODS_QUERY, CaseTypeTypeEnum.END_USER_ADVISORY_QUERY],
        ...
        self.assertIn(CaseTypeTypeEnum.GOODS_QUERY, letter_template.case_types.values_list("id", flat=True))
        self.assertIn(CaseTypeTypeEnum.END_USER_ADVISORY_QUERY, letter_template.case_types.values_list("id", flat=True))
    ...
    def test_create_letter_templates_not_unique_name_failure(self):
        ...
        data = {
            "name": "SIEL",
            "case_types": [CaseTypeTypeEnum.GOODS_QUERY],
            "layout": self.letter_layout.id,
            "letter_paragraphs": [self.picklist_item_1.id, self.picklist_item_2.id],
        }

...
class LetterTemplateCreateTests(DataTestClient):
    ...
    def test_create_letter_templates_success(self):
        ...
        data = {
            ...
            "case_types": [CaseType.CLC_QUERY, CaseType.END_USER_ADVISORY_QUERY],
        ...
        self.assertIn(CaseType.CLC_QUERY, letter_template.case_types.values_list("id", flat=True))
        self.assertIn(CaseType.END_USER_ADVISORY_QUERY, letter_template.case_types.values_list("id", flat=True))

...
S3_CONNECT_TIMEOUT = 5  # Maximum time, in seconds, to wait for a DB connection
S3_REQUEST_TIMEOUT = 5  # Maximum time, in seconds, to wait for a request to return a byte

...
class BaseApplicationSerializer(serializers.ModelSerializer):
    ...
    licence_type = KeyValueChoiceField(
        choices=ApplicationLicenceType.choices,
    ...
    application_denial_reason = ApplicationDenialReasonViewSerializer(
...
class ApplicationStatusUpdateSerializer(BaseApplicationSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        if validated_data.get("status") == get_case_status_by_status(
            ...
            application_denial_reason_serializer = ApplicationDenialReasonSerializer(
                data=data
            )

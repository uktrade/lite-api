...
from applications.models import Application, SiteOnApplication, EndUserOnApplication
from drafts.models import GoodOnDraft, SiteOnDraft, EndUserOnDraft
...
class ApplicationsTests(APITestCase, URLPatternsTestCase):
    ...
    def test_that_endusers_are_added_to_application_when_submitted(self):
        ...
        # enduser = OrgAndUserHelper.create_end_user
        end_user = OrgAndUserHelper.create_end_user('test', self.org)
        unit1 = Units.NAR
        ...
        enduser_on_draft1 = EndUserOnDraft(end_user=end_user, draft=draft)
        ...
        self.assertEqual(EndUserOnApplication.objects.count(), 1)

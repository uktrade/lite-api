...
class ConsigneeOnDraftTests(DataTestClient):
    ...
    def test_post_consignee_document_success(self, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
        And the draft contains a consignee
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    def test_get_consignee_document_success(self, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
        And the draft contains a consignee
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    @mock.patch("documents.models.Document.delete_s3")
    def test_delete_consignee_document_success(self, delete_s3_function, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    @mock.patch("documents.models.Document.delete_s3")
    def test_delete_consignee_success(self, delete_s3_function, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
        ...
        url = reverse("applications:party", kwargs={"pk": self.draft.id, "party_pk": consignee.pk})
        response = self.client.delete(url, **self.exporter_headers)

...
class UltimateEndUsersOnDraft(DataTestClient):
    ...
    def test_post_ultimate_end_user_document_success(self, scan_document_for_viruses_task_function):
        """
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    def test_get_ultimate_end_user_document_success(self, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
        And the draft contains an ultimate end user
    ...
    def test_delete_ultimate_end_user_document_success(
        self, delete_s3_function, scan_document_for_viruses_task_function
    ):
        """
        Given a standard draft has been created
        And the draft contains an ultimate end user
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    @mock.patch("documents.models.Document.delete_s3")
    def test_delete_ultimate_end_user_success(self, delete_s3_function, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
        And the draft contains an ultimate end user
        And the draft contains an ultimate end user document

...
class ThirdPartiesOnDraft(DataTestClient):
    ...
    def test_post_third_party_document_success(self, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    def test_get_third_party_document_success(self, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
        And the draft contains a third party
    ...
    def test_delete_third_party_document_success(self, delete_s3_function, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
        And the draft contains a third party
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    @mock.patch("documents.models.Document.delete_s3")
    def test_delete_third_party_success(self, delete_s3_function, scan_document_for_viruses_task_function):
        """
        Given a standard draft has been created
        And the draft contains a third party
        And the draft contains a third party document

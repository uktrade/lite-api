...
class GoodsTypeOnApplicationTests(DataTestClient):
    ...
    def test_post_goods_type_document_success(self, scan_document_for_viruses_task_function):
        """
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    def test_get_goods_type_document_success(self, scan_document_for_viruses_task_function):
        """
        Given a draft HMRC query has been created
        And the draft contains a goods type
    ...
    def test_delete_goods_type_document_success(self, delete_s3_function, scan_document_for_viruses_task_function):
        """
        Given a draft HMRC query has been created
        And the draft contains a goods type
        And the goods type has a document attached
    ...
    @mock.patch("documents.tasks.scan_document_for_viruses_task.now")
    @mock.patch("documents.models.Document.delete_s3")
    def test_delete_goods_type_success(self, delete_s3_function, scan_document_for_viruses_task_function):
        """
        Given a draft HMRC query has been created
        And the draft contains a goods type
        And the goods type has a document attached

...
from conf.constants import ExporterPermissions, GovPermissions, AutoGeneratedDocuments
    ...
    def put(self, request, pk):
        ...
        if application.case_type.sub_type in [CaseTypeSubTypeEnum.EUA, CaseTypeSubTypeEnum.GOODS] or (
            ...
            if request.data.get("submit_hmrc"):
                auto_generate_case_document("application_form", application, AutoGeneratedDocuments.APPLICATION_FORM)
...
class ApplicationFinaliseView(APIView):
    ...
    def put(self, request, pk):
        ...
        if action in [AdviceType.REFUSE, AdviceType.NO_LICENCE_REQUIRED]:
            ...
            if application.case_type.sub_type in [CaseTypeSubTypeEnum.STANDARD, CaseTypeSubTypeEnum.EXHIBITION]:
                errors = {}

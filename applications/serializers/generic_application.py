...
from applications.serializers.denial_reasons import (
    ApplicationDenialReasonCreateSerializer,
)
    ...
    def get_export_type(self, instance):
        ...
        if hasattr(instance, "export_type"):
            return {
                ...
                "value": get_value_from_enum(
                    ApplicationExportType, instance.export_type
                ),
            }
        return None
...
class GenericApplicationUpdateSerializer(serializers.ModelSerializer):
    ...
    reasons = serializers.PrimaryKeyRelatedField(
        queryset=DenialReason.objects.all(), many=True, write_only=True
    )
    ...
    def update(self, instance, validated_data):
        ...
        if validated_data.get("status") == get_case_status_by_status(
            ...
            application_denial_reason_serializer = ApplicationDenialReasonCreateSerializer(
                data=data
            )

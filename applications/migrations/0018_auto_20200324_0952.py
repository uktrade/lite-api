...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='f680clearanceapplication',
            name='mtcr_type',
            field=models.CharField(choices=[('mtcr_category_1', 'MTCR Category 1'), ('mtcr_category_2', 'MTCR Category 2'), ('none', 'No'), ('unknown', 'Unknown')], max_length=50, null=True),
        ),
        migrations.AddField(
            model_name='f680clearanceapplication',
            name='prospect_value',
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('mod_funded', 'MOD funded'), ('part_mod_part_venture', 'Part MOD part private venture'), ('private_venture', 'Private venture')], max_length=50, null=True),
        ),
    ]

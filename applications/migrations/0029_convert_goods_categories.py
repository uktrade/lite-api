# Generated by Django 2.2.11 on 2020-05-01 15:36

from django.db import migrations


def convert_goods_categories(apps, schema_editor):
    StandardApplication = apps.get_model("cases", "StandardApplication")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('applications', '0028_standardapplication_contains_firearm_goods'),
    ]

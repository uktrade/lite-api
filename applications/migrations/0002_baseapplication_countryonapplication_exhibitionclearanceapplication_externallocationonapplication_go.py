    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_type', models.CharField(choices=[('standard_licence', 'Standard Licence'), ('open_licence', 'Open Licence'), ('hmrc_query', 'HMRC Query'), ('exhibition_clearance', 'MOD Exhibition Clearance')], default=None, max_length=50)),
                ('activity', models.TextField(blank=True, default=None, null=True)),
                ('usage', models.TextField(blank=True, default=None, null=True)),
                ('licence_duration', models.IntegerField(default=None, help_text='Set when application finalised', null=True)),
            ],
            options={
                'abstract': False,
            },

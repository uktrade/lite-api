...
def get_default_duration(application):
    ...
    if (
        application.application_type == ApplicationType.STANDARD_LICENCE and
        application.export_type == ApplicationExportType.PERMANENT
    ):
        return 2 * 12

    if (
        application.application_type == ApplicationType.OPEN_LICENCE and
        application.export_type == ApplicationExportType.PERMANENT
    ):

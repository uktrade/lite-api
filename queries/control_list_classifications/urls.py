...
urlpatterns = [
    ...
    path(
        "",
        views.ControlListClassificationsList.as_view(),
        name="control_list_classifications",
    ),
    # ex: /queries/control-list-classifications/<int:pk>/ - Retrieve details about a specific query
    path(
        "<int:pk>/",
        views.ControlListClassificationDetail.as_view(),
        name="control_list_classification",
    ),
]

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('party_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='parties.Party')),
                ('sub_type', models.CharField(choices=[('intermediate_consignee', 'Intermediate Consignee'), ('agent', 'Agent'), ('submitter', 'Authorised Submitter'), ('consultant', 'Consultant'), ('contact', 'Contact'), ('exporter', 'Exporter'), ('other', 'Other')], default='other', max_length=22)),
            ],
            bases=('parties.party',),
        ),
        migrations.CreateModel(

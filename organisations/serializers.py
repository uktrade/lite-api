...
from users.serializers import ExporterUserCreateSerializer
...
class OrganisationCreateSerializer(serializers.ModelSerializer):
    ...
    user = ExporterUserCreateSerializer(write_only=True)
    ...
    def create(self, validated_data):
        ...
        user_serializer = ExporterUserCreateSerializer(data=user_data)
        with reversion.create_revision():

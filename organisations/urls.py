...
urlpatterns = [
    ...
    path('<uuid:org_pk>/sites/<uuid:site_pk>/',
         views_site.OrgSiteDetail.as_view(), name='organisation_site'),
    path('<uuid:org_pk>/endusers/', views_site.OrgEndUserList.as_view(), name='organisation_endusers'),
    path('<uuid:org_pk>/endusers/<uuid:site_pk>/',
         views_site.OrgEndUserList.as_view(), name='organisation_enduser'),

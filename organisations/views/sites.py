...
class SitesList(APIView):
    ...
    def get(self, request, org_pk):
        ...
        if isinstance(request.user, ExporterUser):
            ...
            sites = list(Site.objects.get_by_user_organisation_relationship(user_organisation_relationship).exclude(address__country__id__in=request.GET.getlist("exclude")))
        else:

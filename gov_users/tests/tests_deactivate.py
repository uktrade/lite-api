...
class GovUserDeactivateTests(DataTestClient):
    ...
    def test_deactivate_a_user(self):
        ...
        self.assertEqual(
            GovUser.objects.get(id=self.valid_user.id).status, GovUserStatuses.DEACTIVATED,
        )
    ...
    def test_deactivate_and_reactivate_a_user(self):
        ...
        response = self.client.get(
            reverse("gov_users:gov_users"), **{"HTTP_GOV_USER_TOKEN": user_to_token(self.valid_user)}
        )
